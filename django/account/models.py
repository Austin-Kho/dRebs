...
class StaffAuth(models.Model):
    ...
    assigned_project = models.ForeignKey(Project, related_name='assigned_project', on_delete=models.SET_NULL, null=True, blank=True, verbose_name='담당 메인 프로젝트', help_text='선택한 프로젝트를 각 화면에서 기본 프로젝트로 보여줍니다.')
    allowed_projects = models.ManyToManyField(Project, related_name='allowed_projects', null=True, blank=True, verbose_name='허용 프로젝트', help_text='조회 및 관리할 수 있는 프로젝트들을 선택합니다.')
