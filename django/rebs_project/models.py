...
class Project(models.Model):
    ...
    is_direct_manage = models.BooleanField('직영운영여부', default=False, help_text='본사 직접 운영하는 프로젝트인 경우 체크, 즉 시행대행이나 업무대행이 아닌 경우')
...
class SiteContract(models.Model):
    ...
    total_prices = models.PositiveBigIntegerField('총매매대금')
