...
class SalesPriceByGT(models.Model):  # 차수별 타입별 분양가격
    ...
    price_build = models.PositiveIntegerField('건물가', null=True)
    price_land = models.PositiveIntegerField('대지가', null=True)
    price_tax = models.PositiveIntegerField('부가세', null=True)
